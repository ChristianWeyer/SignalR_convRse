...
(function ($, window) {
    ...
    $.hubConnection.prototype.createHubProxies = function () {
        ...
        proxies.chat.server = {
            ...
            sendMessageForRoom: function (room, message) {
                return proxies.chat.invoke.apply(proxies.chat, $.merge(["SendMessageForRoom"], $.makeArray(arguments)));
             }
        };
        ...
        proxies.monitor.server = {
            publishEvent: function (eventType, connection) {
                return proxies.monitor.invoke.apply(proxies.monitor, $.merge(["PublishEvent"], $.makeArray(arguments)));
             }
        };
